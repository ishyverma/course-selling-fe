...
export const SignupPage = () => {
    ...
    return <div>
        <div>
            <Navbar />
            <div className="mt-24 flex justify-center items-center h-[80vh]">
                <div className="bg-gradient-to-b from-[#161821] to-[#1C2234] rounded-2xl p-6">
                    ...
                    <div className="mt-8">
                        <label htmlFor="firstname" className="text-white text-sm">First Name</label> <br />
                        <input ref={firstNameRef} className="bg-[#222735] text-white outline-none font-satoshi py-2 px-2 w-full rounded-md text-sm mt-1" placeholder="Harkirat" type="text" id="firstname" required />
                    </div>
                    <div className="mt-8">
                        <label htmlFor="lastname" className="text-white text-sm">Last Name</label> <br />
                        <input ref={lastNameRef} className="bg-[#222735] text-white outline-none font-satoshi py-2 px-2 w-full rounded-md text-sm mt-1" placeholder="Singh" type="text" id="lastname" required />
                    </div>
                    <div className="mt-8">
                    ...
                    <div className="mt-4">
                        <button onClick={signup} className="flex justify-center gap-1 content-center bg-gradient-to-t from-[#2456dc] to-[#5091f2] text-white font-satoshi text-sm hover:to-[#4477C6] hover:from-[#1E47B2] hover:text-[#E1E2E4] py-3 px-6 rounded transition-all w-full">
                            Sign Up
                        </button>
                    </div>
                </div>
